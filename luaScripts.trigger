...
-- elseif (rodCount == 6) then
	...
	send("cast mystic warrior at me")
end

if (matches[2] == 'Ramuh') then
	isEsongTrue = true;
end
...
expandAlias("stb");</script>
			...
			<TriggerGroup isActive="yes" isFolder="yes" isTempTrigger="no" isMultiline="no" isPerlSlashGOption="no" isColorizerTrigger="no" isFilterTrigger="no" isSoundTrigger="no" isColorTrigger="no" isColorTriggerFg="no" isColorTriggerBg="no">
				...
				<Trigger isActive="yes" isFolder="no" isTempTrigger="no" isMultiline="no" isPerlSlashGOption="no" isColorizerTrigger="no" isFilterTrigger="no" isSoundTrigger="no" isColorTrigger="no" isColorTriggerFg="no" isColorTriggerBg="no">
					<name>backstab</name>
					<script>if (monsterTarget == 'monster') then
	monsterTarget = toLowerCase(matches[2]);
end
if (isPartied == false) then
	backstab(oppExit);
end</script>
					...
					<regexCodeList>
						...
						<string>^Devout concentrates and projects (.*) chi blast of mental force at you!$</string>
					</regexCodeList>
					<regexCodePropertyList>
						<integer>1</integer>
						<integer>3</integer>
...
expandAlias("inn");</script>
	...
	expandAlias("bs")
			...
			<Trigger isActive="yes" isFolder="no" isTempTrigger="no" isMultiline="no" isPerlSlashGOption="no" isColorizerTrigger="no" isFilterTrigger="no" isSoundTrigger="no" isColorTrigger="no" isColorTriggerFg="no" isColorTriggerBg="no">
				<name>new round</name>
				<script>if ((isTfisting == true and isCasting == false) or (isBackstabbing == true and isCasting == true))then
	expandAlias("stb");
end</script>
				<triggerType>0</triggerType>
				<conditonLineDelta>0</conditonLineDelta>
...
expandAlias("wep");</script>
			...
			<Trigger isActive="yes" isFolder="no" isTempTrigger="no" isMultiline="no" isPerlSlashGOption="no" isColorizerTrigger="no" isFilterTrigger="no" isSoundTrigger="no" isColorTrigger="no" isColorTriggerFg="no" isColorTriggerBg="no">
				...
				<script>if ((matches[2] == 'corpse' or matches[2] == 'carrion') and isLootedRoom == false) then
...
if (isBackstabbing == true and inCombat == false and isDisruptionFieldActive == false) then
	...
	tempTimer(1.8, function() processSpellSupport('disruption field'); end);
				...
				<Trigger isActive="yes" isFolder="no" isTempTrigger="no" isMultiline="no" isPerlSlashGOption="no" isColorizerTrigger="no" isFilterTrigger="no" isSoundTrigger="no" isColorTrigger="no" isColorTriggerFg="no" isColorTriggerBg="no">
					...
					<script>backstab(oppExit);
isDisruptionFieldActive = true;
temptimer(300, function() isDisruptionFieldActive = false; end);</script>
					<triggerType>0</triggerType>
					<conditonLineDelta>0</conditonLineDelta>
					<mStayOpen>0</mStayOpen>
					<mCommand></mCommand>
...
devoutDir = matches[2];
		...
		<TriggerGroup isActive="yes" isFolder="yes" isTempTrigger="no" isMultiline="no" isPerlSlashGOption="no" isColorizerTrigger="no" isFilterTrigger="no" isSoundTrigger="no" isColorTrigger="no" isColorTriggerFg="no" isColorTriggerBg="no">
			...
			<Trigger isActive="yes" isFolder="no" isTempTrigger="no" isMultiline="no" isPerlSlashGOption="no" isColorizerTrigger="no" isFilterTrigger="no" isSoundTrigger="no" isColorTrigger="no" isColorTriggerFg="no" isColorTriggerBg="no">
				...
				<script>if (isPartied == true) then
	test('checktoinn');
	tempTimer(3.5, checkToInnervate());
end</script>
				<triggerType>0</triggerType>
				<conditonLineDelta>0</conditonLineDelta>
				<mStayOpen>0</mStayOpen>
...
identifyDtype(matches[2]);
send("unalias \\qatel");</script>
				<command></command>
				<packageName></packageName>
				<regex>^qid (.*)$</regex>
			</Alias>
...
send("party create " .. partyName)</script>
			...
			<Alias isActive="yes" isFolder="no">
				...
				<script>isLoadingPartyInfo = true;
isPartied = true;
...
send("use hamstring at " .. target)</script>
			...
			<Alias isActive="yes" isFolder="no">
				...
				<script>seconds = tonumber(matches[2])
if (seconds == '') then
...
send("use stab at " .. monsterTarget)</script>
			...
			<Alias isActive="yes" isFolder="no">
				...
				<script>if (monsterTarget ~= 'monster' and monsterTarget ~= '') then
...
send("heal2")</script>
	...
	monsterTarget = matches[2];
			...
			<Alias isActive="yes" isFolder="no">
				<name>backstab</name>
				<script>-- test('(bs) : ' .. tostring(isBackstabbing));
if (isCasting == false and isBackstabbing == false) then
	...
	isBackstabbing = true;
  if (monsterTarget ~= 'monster' and monsterTarget ~= '') then
...
send("cast destroy field")</script>
				<command></command>
				<packageName></packageName>
				<regex>^df$</regex>
			</Alias>
...
send("sell all " .. item)</script>
		...
		<AliasGroup isActive="yes" isFolder="yes">
			...
			<Alias isActive="yes" isFolder="no">
				...
				<script>expandAlias("wl")
send("cast soothe the beast")</script>
				<command></command>
				<packageName></packageName>
				<regex>^sb$</regex>
			</Alias>
...
chainCasting = true;
mwCount = 1;
if (isWielded == false) then
	send('wl')
end
if (item == '') then
	item = 'weapon'
else
	send("cast mystic weapon at " .. item)
end</script>
				<command></command>
				<packageName></packageName>
				<regex>^mwc (.*)$</regex>
...
expandAlias("wl")
send("cast world transport at " .. city)</script>
				<command></command>
				<packageName></packageName>
				<regex>^wt (.*)$</regex>
			</Alias>
...
send("use practice");</script>
			...
			<Alias isActive="yes" isFolder="no">
				...
				<script>-- spell = 'water breathing at ' .. matches[2]
-- send("cast " .. spell)
-- processSpellSupport
processSpellSupport('water breathing', matches[2]);</script>
				<command></command>
				<packageName></packageName>
				<regex>^wb (.*)$</regex>
			</Alias>
...
elseif (target == '') then
	...
	send("cast emotion song at " .. target);
			...
			<Alias isActive="yes" isFolder="no">
				...
				<script>target = matches[2];
processSpellDamage('engaging banter', target);</script>
				<command></command>
				<packageName></packageName>
				<regex>^bt (.*)$</regex>
			</Alias>
			...
			<Alias isActive="yes" isFolder="no">
				...
				<script>memberTarget = matches[2];
spell = "cure light wounds at " .. memberTarget;
send("cast " .. spell);</script>
				<command></command>
				<packageName></packageName>
				<regex>^clw (.*)$</regex>
			...
			<Alias isActive="yes" isFolder="no">
				<name>identify</name>
				<script>spell = "identify at " .. matches[2];
send("cast " .. spell);</script>
				<command></command>
				<packageName></packageName>
				<regex>^id (.*)$</regex>
